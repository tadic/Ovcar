 ...
 * @author ivantadic
 */
public class ListaOvacaBlankoIzvestaj {
    private List<Ovca> list;
    private String f1, f2, f3,f4, nazivListe;
    private Map<String, Object> params = new HashMap<String, Object>();
    public ListaOvacaBlankoIzvestaj(List<Ovca> list, String nazivListe, String f1, String f2, String f3, String f4){
        this.list = list;
        this.f1 = f1;
        this.f2 = f2;
        this.f3 = f3;
    ...
    public void create(){
        ...
        try
        {
            String reportSource = "listOvceBlanko.jrxml";
