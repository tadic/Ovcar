 ...
 * @author ivantadic
 */
public class Podaci_ovaca_statistika extends javax.swing.JPanel {
     ...
     */
    public Podaci_ovaca_statistika(JPanel mainPanel, Logic logic) {
        this.logic = logic;
        ...
        setBoldFontToColumn(13, Color.red.darker());
        setBoldFontToColumn(10, Color.black);
    ...
    private Vector vectorFrom(Ovca o){
        int brojJagnjenj = o.getBrojJagnjenja();
        Vector v = new Vector();
        v.add(o.getOznaka());
        v.add(o.getNadimak());
        if (o.getPol()=='m'){
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ovce statistika");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "oznaka", "nadimak", "pol", "% R", "starost", "iz legla od", "ojagnjila", "jagnjenja", "% jagnjenja", "prosek izmđu", "jag./god.", "index", "id", "aktuelno", "status"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Float.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class
            };
            boolean[] canEdit = new boolean [] {
                true, true, false, false, false, false, true, false, false, false, false, false, false, true, false
            };
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
        ...
        if (c== KeyEvent.VK_ENTER){
            ...
            String id = jTable1.getModel().getValueAt(clickedRow,12).toString();
            mainPanel.removeAll();
    ...
    private void jSnimiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSnimiActionPerformed
            for (int i=0; i<jTable1.getRowCount(); i++){
                ...
                String aktuelno = (String) jTable1.getModel().getValueAt(selectedRow,13);
                Object oznaka = jTable1.getModel().getValueAt(selectedRow,0);
                Object nadimak = jTable1.getModel().getValueAt(selectedRow,1);
               // if (aktuelno!=null){
                    String id = jTable1.getModel().getValueAt(selectedRow,12).toString();
