 ...
 * @author ivantadic
 */
public class ParenjePanel extends javax.swing.JPanel {
...
private JPanel mainPanel;
    ...
    public ParenjePanel(JPanel mainP, Logic logic, Aktivnost aktivnost) {
        super();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "nadimak", "oznaka", "starost", "aktuelno", "napomena", "id"
            }
        ) {
        ...
        jLabel18.setFont(new java.awt.Font("Monaco", 0, 16)); // NOI18N
        jLabel18.setText("Ovan:");

        jTip.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Spajanje", "Odvajanje", "Parenje" }));

        jLabel19.setFont(new java.awt.Font("Monaco", 0, 16)); // NOI18N
        jLabel19.setText("Tip");

        jOvan.setEditable(true);
        jOvan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Spajanje", "Odvajanje", "Parenje" }));
    ...
    private void setPanel(){
        ...
        jOvan.setModel(new DefaultComboBoxModel(logic.getSveOvnove().toArray()));
        AutoCompleteDecorator.decorate(this.jOvan);
        
        if (aktivnost.getParenja()==null || aktivnost.getParenja().isEmpty()){
...
//        paintColumns();
        ...
        private void fillTable(List<Parenje> parenja, JTable table){
             DefaultTableModel model = (DefaultTableModel) table.getModel();
            for (int i=0; i<parenja.size(); i++){
                model.addRow(vector2From(parenja.get(i)));
            }
            jCounter.setText("("+ jTable1.getRowCount() + ")");
            jTip.setSelectedItem(parenja.get(0).getTip());
    }
  ...
  private String convertHours(int h){
    ...
    private List<Parenje> pickSvaParenja(){
        List<Parenje> list = new ArrayList<Parenje>(); 
        TableModel table = jTable1.getModel();
        for (int i=0; i<table.getRowCount(); i++){
                list.add(pickParenje(table, i));
        }
        return list;
    }
    ...
    private void pickDataFromForm(){
        ...
        aktivnost.setTroskovi(jOvan.getSelectedItem());
        aktivnost.setNapomena(jNapomena.getText());
      
        aktivnost.setParenja(pickSvaParenja());
    ...
    private boolean tableModelContaintsOvca(DefaultTableModel model, Ovca o){
        for (int i=0; i<model.getRowCount(); i++){
            if (model.getValueAt(i, 5)== o.getId()){
                return true;
            }
        }
        return false;
    ...
    private String createBilans(){
        int komada = aktivnost.getParenja().size();
       
        StringBuilder sb = new StringBuilder(aktivnost.getParenja().get(0).getTip());
        sb.append(" , ovan: ").append(aktivnost.getParenja().get(0).getOvan()).append(" i ");
        sb.append(OvcaHelper.mnozinaGro(komada));
        return sb.toString();
        
    }
    private Vector vector2From(Parenje p){
        Vector v = new Vector(); 
        v.add(p.getOvca().getOznaka());
        v.add(p.getOvca().getNadimak());
        v.add(p.getOvca().getStarost());
        v.add(p.getOvca().getAktuelno());
        v.add(p.getNapomena());

        v.add(p.getOvca().getId());
        return v;
    }
    ...
    private javax.swing.JComboBox jTip;
